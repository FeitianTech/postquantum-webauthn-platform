...
vi.mock('../../static/scripts/advanced/display-utils.js', () => ({
...
vi.mock('../../static/scripts/advanced/constants.js', () => ({
  ATTACHMENT_LABELS: {
    platform: 'Platform',
...
import { deriveAllowedAttachmentsFromHints } from '../../static/scripts/advanced/hints.js';
import { checkLargeBlobCapability, updateAuthenticationExtensionAvailability } from '../../static/scripts/advanced/forms.js';
...
import { deleteCredentialArtifact, fetchCredentialArtifact } from '../../static/scripts/shared/credential-artifacts-client.js';
