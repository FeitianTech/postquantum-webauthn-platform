...
vi.mock('../static/scripts/shared/navigation.js', () => ({
  switchTab: vi.fn(),
  switchSubTab: vi.fn(),
  toggleSection: vi.fn(),
...
vi.mock('../static/scripts/advanced/resets.js', () => ({
...
vi.mock('../static/scripts/simple/auth-simple.js', () => ({
  simpleRegister: vi.fn(),
  simpleAuthenticate: vi.fn(),
}));

vi.mock('../static/scripts/advanced/auth-advanced.js', () => ({
  advancedRegister: vi.fn(),
  advancedAuthenticate: vi.fn(),
}));

vi.mock('../static/scripts/decoder/codec.js', () => ({
  processCodec: vi.fn(),
  clearCodec: vi.fn(),
...
vi.mock('../static/scripts/advanced/mds.js', () => ({
...
vi.mock('../static/scripts/advanced/json-editor-utils.js', () => ({
...
vi.mock('../static/scripts/advanced/settings-nav.js', () => ({
  initializeAdvancedSettingsNavigation: vi.fn(),
}));

vi.mock('../static/scripts/shared/analyze-browser.js', () => ({
...
import { createFakeAllowCredential, createFakeExcludeCredential, removeFakeAllowCredential, removeFakeExcludeCredential } from '../static/scripts/advanced/exclude-credentials.js';
import { checkLargeBlobCapability, randomizeChallenge, randomizeLargeBlobWrite, randomizePrfEval, updateAuthenticationExtensionAvailability, updateFieldLabels, validateChallengeInputs, validateLargeBlobWriteInput, validatePrfEvalInputs, validatePrfInputs, validateUserIdInput } from '../static/scripts/advanced/forms.js';
import { registerHintsChangeCallback } from '../static/scripts/advanced/hints.js';
import { waitForMetadataLoad } from '../static/scripts/advanced/mds.js';
import { initializeAdvancedSettingsNavigation } from '../static/scripts/advanced/settings-nav.js';
import { loadSavedCredentials, updateAllowCredentialsDropdown } from '../static/scripts/advanced/credential-display.js';
import { updateJsonEditor, updateJsonFromForm } from '../static/scripts/advanced/json-editor.js';
import { handleJsonEditorKeydown } from '../static/scripts/advanced/json-editor-utils.js';
import { initializeNavigationMenu } from '../static/scripts/shared/navigation.js';
import { initializeSimpleUsername, randomizeUserIdentity } from '../static/scripts/shared/username.js';
import { closeModal, initializeStickyHeader, toggleJsonEditorExpansion } from '../static/scripts/shared/ui.js';
import { initializeAnalyzeBrowser } from '../static/scripts/shared/analyze-browser.js';
import { initializeLoader, loaderComplete, loaderSetPhase } from '../static/scripts/shared/loader.js';
...
async function importMainFresh() {
  vi.resetModules();
  return import('../static/scripts/main.js');
}
