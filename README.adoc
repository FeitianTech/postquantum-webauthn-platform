...
4. **Start the web service**
   ...
   - On import, the logging module spawns a background task that ensures the scheduled cleanup workflow exists in the log repository.

5. **Register a WebAuthn credential**
