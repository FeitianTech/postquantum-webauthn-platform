...
1. Choose the **Docker** environment and point it at this repository.
2. Leave the Build Command and Start Command fields empty so Render runs the Dockerfile directly.
