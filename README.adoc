...
## 6) Run the example scripts (no PQC)

Common example entry points in this repo (or in similar layouts). Use the one that exists in your clone:

    - `python examples/server.py`
    - `python examples/flask_app.py`
    - `python examples/ctap2/credential.py`
