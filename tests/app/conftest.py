...
def storage_module():
    ...
    return pytest.importorskip("server.app.storage")
...
def credential_artifacts_module():
    ...
    return pytest.importorskip("server.app.credential_artifacts")
...
def device_logs_module():
    ...
    return pytest.importorskip("server.app.device_logs")
...
def pqc_module():
    ...
    return pytest.importorskip("server.app.pqc")
...
def attachments_module():
    ...
    return pytest.importorskip("server.app.attachments")
...
def challenge_registry_module():
    ...
    return pytest.importorskip("server.app.challenge_registry")
