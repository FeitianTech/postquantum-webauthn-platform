...
def test_credentials_get_serializes_dict_backed_entries(monkeypatch, metadata_module, attestation_module, storage_module):
...
def test_credentials_get_serializes_object_backed_entries_and_derives_authenticator_data(monkeypatch, metadata_module, attestation_module, storage_module):
    config_module = pytest.importorskip("server.app.config")
    pytest.importorskip("server.app.app")
...
def test_credentials_get_handles_bare_credential_objects_and_skips_malformed(monkeypatch, metadata_module, attestation_module, storage_module):
    config_module = pytest.importorskip("server.app.config")
    pytest.importorskip("server.app.app")
...
def test_credentials_get_returns_empty_list_when_storage_iteration_fails(monkeypatch, metadata_module, storage_module):
    ...
    monkeypatch.setattr(storage_module, "iter_credentials", _raise_iter_failure)
...
def test_credentials_delete_returns_zero_when_listing_credentials_raises(monkeypatch, metadata_module, storage_module):
    ...
    monkeypatch.setattr(storage_module, "list_credentials", _raise_list_failure)
